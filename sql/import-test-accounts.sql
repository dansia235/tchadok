-- ================================================================
-- Script d'importation des comptes de test - Tchadok Platform
-- ================================================================
-- À importer directement via phpMyAdmin
-- Mot de passe pour tous les comptes : tchadok2024
-- ================================================================

-- Utiliser la base de données tchadok
USE tchadok;
...
-- Supprimer les artistes de test
DELETE FROM artists
WHERE user_id IN (
...
-- ================================================================
-- ÉTAPE 2: INSERTION DES NOUVEAUX COMPTES
-- ================================================================
-- IMPORTANT: La table users a 2 colonnes password (password ET password_hash)
-- Les deux doivent être remplies !
-- ================================================================
...
INSERT INTO `users` (
    ...
    `gender`, `premium_status`, `email_verified`, `is_active`, `created_at`
) VALUES (
    'admin_test',
...
INSERT INTO `users` (
    `username`, `email`, `password`, `password_hash`,
    `first_name`, `last_name`, `phone`, `country`, `city`,
    `date_of_birth`, `gender`, `premium_status`, `premium_expires_at`,
    `wallet_balance`, `loyalty_points`, `email_verified`, `is_active`, `created_at`
) VALUES (
    'fan_test1',
...
INSERT INTO `users` (
    `username`, `email`, `password`, `password_hash`,
    `first_name`, `last_name`, `phone`, `country`, `city`,
    `date_of_birth`, `gender`, `premium_status`,
    `wallet_balance`, `loyalty_points`, `email_verified`, `is_active`, `created_at`
) VALUES (
    'fan_test2',
...
INSERT INTO `users` (
    ...
    `first_name`, `last_name`, `phone`, `country`, `city`,
    `date_of_birth`, `gender`, `premium_status`,
    `wallet_balance`, `email_verified`, `is_active`, `created_at`
) VALUES (
    'artist_test1',
...
-- ================================================================
-- ÉTAPE 3: INSERTION DES PROFILS SPÉCIALISÉS
-- ================================================================
...
INSERT INTO `artists` (
    `user_id`, `stage_name`, `real_name`, `bio`,
    `facebook`, `instagram`, `twitter`, `youtube`,
    `birth_date`, `birth_place`, `genres`,
    `verified`, `featured`, `total_streams`, `total_sales`,
    `total_earnings`, `commission_rate`, `is_active`, `created_at`
)
SELECT
    id,
    'Ngar Star',
...
SELECT
    ...
    u.wallet_balance,
    CASE
        WHEN art.id IS NOT NULL THEN 'Artiste'
...
ORDER BY
    CASE
        ...
        WHEN art.id IS NOT NULL THEN 2
        ELSE 3
    END,
    u.id;
...
-- ================================================================
SELECT
    CONCAT('✅ ', COUNT(*), ' comptes de test créés avec succès !') as message
FROM users
WHERE email LIKE '%@test.tchadok.td';
